...
- Configured your GitHub account to Git: details can be found on [this document](https://services.github.com/on-demand/downloads/github-git-cheat-sheet.pdf) (which is also a handy list of the most used commands)
